...
<head>
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response == 1) {
                        ...
                        alert("No se pudo eliminar la promocion. Inténtalo de nuevo.");
                    }
                },
                error: function() {
    ...
    function verDetalles(id) {
        window.location.href = 'detalles_promociones.php?id=' + id;
    }

    function Editar(id) {
        window.location.href = 'editar_promociones.php?id=' + id;
    }
    </script>
</head>
<body>
<?php include('menu.php') ?>
    <div class="productos">
        ...
        <div class="nuevo_registro">
            <a href="promociones_alta.php">Dar de Alta una Promocion</a>
        </div>
        <?php
